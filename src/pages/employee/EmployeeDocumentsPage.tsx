              ...
              >
                <div className="flex items-start gap-3">
                  <div className="p-2.5 rounded-lg bg-camublue-900/10 shrink-0">
                    <FileText size={20} className="text-camublue-900" />
                  </div>
                ...
                {doc.file_url && (
                  <a
                    ...
                    rel="noreferrer"
                    download
                    className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-camublue-900 text-white text-sm font-medium hover:bg-camublue-900/90 transition"
                  >
                    <Download size={15} />
                    Télécharger
                  </a>
