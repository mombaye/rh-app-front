    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-black/80" onClick={onClose}>
      ...
      >
        {type === "pdf" && doc.file_url && (
          <iframe src={doc.file_url} className="w-full h-full rounded-lg bg-white" title={doc.title} />
        )}
        {type === "image" && doc.file_url && (
          <img src={doc.file_url} alt={doc.title} className="max-w-full max-h-full object-contain rounded-lg shadow-xl" />
        )}
        {type === "none" && (
                  ...
                  <div className="flex gap-2 mt-auto">
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg border text-sm font-medium transition ${
                        canPreview
                          ? "border-[#003c71] text-[#003c71] hover:bg-[#003c71]/10"
                    ...
                    {doc.file_url && (
                      <a
                        ...
                        rel="noreferrer"
                        download
                        className="flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-[#003c71] text-white text-sm font-medium hover:bg-[#003c71]/90 transition"
                        title="Télécharger"
                      >
                        <Download size={15} />
                      </a>
