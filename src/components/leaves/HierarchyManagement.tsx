        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4"
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[85vh]"
              ...
              {bulkSelected.size > 0 && (
              <div className="px-6 py-4 border-b border-gray-100 flex-shrink-0 bg-emerald-50">
                <p className="text-xs font-semibold text-emerald-700 mb-3">
                  {bulkSelected.size} employé(s) sélectionné(s)
                </p>
                <div className="flex flex-wrap gap-2">
                  {selectedEmpsDetail.map(emp => (
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 bg-white rounded-xl border border-emerald-300 hover:bg-red-50 hover:border-red-300 transition text-xs font-medium"
                    ...
                    >
                      ...
                      <span className="text-gray-800">{emp.nom} {emp.prenom}</span>
                      <X size={12} className="opacity-60 ml-1" />
                    </button>
                  ))}
                </div>
              </div>
