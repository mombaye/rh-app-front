        ...
        >
          ...
          <div className="p-6 space-y-5">
            ...
            <div className={`flex items-start gap-4 rounded-xl border p-4 ${
              isPE ? "bg-violet-50 border-violet-100" : "bg-orange-50 border-orange-100"
            }`}>
              <div className={`p-2.5 rounded-xl shrink-0 ${isPE ? "bg-violet-100" : "bg-orange-100"}`}>
                {isPE
              ...
              <div className="flex-1 min-w-0">
                <p className={`text-sm font-bold ${isPE ? "text-violet-700" : "text-orange-700"}`}>
                  {isPE ? "Fin de période d'essai" : "Fin de contrat CDD"}
                </p>
